...
export const about = {
  ...
  facts: [
    ...
    { label: 'Availability', value: 'In internship at Alstom Transport Canada Inc' },
  ],
  skills: ['Python', 'C++', 'C#', 'ARM', 'LaTeX', 'AI/ML', 'Git/GitHub', 'Video Editing', 'SQL', 'Power Apps'],
}
...
export const projects: Project[] = [
  {
    ...
    description: 'A Powerful and User-Friendly Minecraft Launcher/Injector for Windows (Bedrock Edition) - DISCONTINUED',
    year: '2023',
  ...
  },
  {
    ...
    description: 'Universal DLL Injector for Windows 7 and later, built with a WinUI 3-like interface.',
    year: '2025',
    tags: ['C#', 'XAML', 'WinUI 3'],
  ...
  },
  {
    ...
    description: 'A GeoGuessr Application/Player with Discord Rich Presence implementation and other tools to enhance the gaming experience.',
    year: '2024',
    tags: ['C#', 'XAML'],
